...
module.exports = function(S) {
  ...
  class RuntimeWebpack extends S.classes.Runtime {
    ...
    _copyExternalModules(func, stats, pathDist) {
      ...
      return BbPromise.all(moduleNames.map(moduleName => {
        return this._resolveModule(func.getRootPath(), moduleName)
          .then(srcPath => {
            const destPath = path.join(pathDist, 'node_modules', moduleName);
